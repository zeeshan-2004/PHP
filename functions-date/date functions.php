...
| `l`    | Full day name         | `Sunday` | "**L**ong day name"        |
   'N'   | week day no           |  1(mon)  | starting mon
   'w'   | week day no           |  0(sun)  | starting sun
   'W'   | year week no          |  37      | starting sun
   'z'   |  year day no          |  256     | starting sun
   't'   |  month day            |  30      | starting sun
